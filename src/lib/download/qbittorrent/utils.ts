import { NormalizedTorrent, Torrent, TorrentState } from "@/lib/download/qbittorrent/types"

export enum NormalizedTorrentState {
...
export function _normalizeTorrentData(torrent: Torrent): NormalizedTorrent {
